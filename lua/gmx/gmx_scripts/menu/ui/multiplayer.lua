...
local function add_category(categories, type, name, expanded, search_query)
	...
	gmx.SetVGUIElementColor(category.Header, category.Header.SetTextColor, "Text")
	...
	fetch_servers(type, function(server)
		...
		gmx.SetVGUIElementColor(label, label.SetTextColor, "Text")
		label:SetTall(64)
		label:Dock(FILL)
		...
		gmx.SetVGUIElementColor(gamemode_label, gamemode_label.SetTextColor, "Text")
		...
		gmx.SetVGUIElementColor(ply_count_label, ply_count_label.SetTextColor, "Text")
		...
		gmx.SetVGUIElementColor(ip_label, ip_label.SetTextColor, "Text")
		...
		for _, tag in ipairs(server.Tags) do
			...
			gmx.SetVGUIElementColor(tag_label, tag_label.SetTextColor, "Text")
...
local function show_servers()
	...
	gmx.SetVGUIElementColor(search_input_header, search_input_header.SetTextColor, "Text")
	...
	gmx.SetVGUIElementColor(search_input, search_input.SetTextColor, "Text")
