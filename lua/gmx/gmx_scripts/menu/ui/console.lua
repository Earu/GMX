...
function console:Paint(w, h)
	local alpha = (gmx.Colors.Background.r > 128 and gmx.Colors.Background.g > 128 and gmx.Colors.Background.b > 128) and 150 or 200
...
function console_input_header:Paint(w, h)
	local alpha = (gmx.Colors.BackgroundStrip.r > 128 and gmx.Colors.BackgroundStrip.g > 128 and gmx.Colors.BackgroundStrip.b > 128) and 150 or 200
