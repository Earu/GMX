...
local function set_vgui_element_color(panel, setter_fn, color_type)
	setter_fn(panel, gmx.Colors[color_type])
end
...
local LUA_EDITOR = {
	...
	Init = function(self)
		...
		set_vgui_element_color(self.RunClientButton, self.RunClientButton.SetTextColor, "Text")
		...
		set_vgui_element_color(self.RunMenuButton, self.RunClientButton.SetTextColor, "Text")
		...
		for _, option in ipairs(options) do
			set_vgui_element_color(option, option.SetTextColor, "Text")
		...
		for _, panel in pairs(self.MenuBar:GetChildren()) do
			if panel.ClassName == "DButton" then
				set_vgui_element_color(panel, panel.SetTextColor, "Text")
		...
		set_vgui_element_color(self.LblRunStatus, self.LblRunStatus.SetTextColor, "Text")
		...
		set_vgui_element_color(self.ThemeSelector, self.ThemeSelector.SetTextColor, "Text")
		...
		set_vgui_element_color(self.LangSelector, self.LangSelector.SetTextColor, "Text")
	...
	OpenFile = function(self, location)
		...
		set_vgui_element_color(frame.lblTitle, frame.lblTitle.SetTextColor, "Text")
	...
	NewTab = function(self, code, name)
		...
		set_vgui_element_color(tab, tab.SetTextColor, "Text")
		...
		close_btn:SetText("x")
		set_vgui_element_color(close_btn, close_btn.SetTextColor, "Text")
...
local function init_editor()
	...
	set_vgui_element_color(p.lblTitle, p.lblTitle.SetTextColor, "Text")
